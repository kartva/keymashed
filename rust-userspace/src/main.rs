...
const VIDEO_WIDTH: u32 = 400;
const VIDEO_HEIGHT: u32 = 300;

const AUDIO_SEND_ADDR: &str = "127.0.0.1:44001";
const AUDIO_DEST_ADDR: &str = "127.0.0.1:44002";
const VIDEO_SEND_ADDR: &str = "127.0.0.1:44443";
const VIDEO_DEST_ADDR: &str = "127.0.0.1:44406";
...
fn main() -> std::io::Result<()> {
    ...
    let window = video_subsystem.window("rust-userspace", VIDEO_WIDTH, VIDEO_HEIGHT)
        .position_centered()
        .build().unwrap();
    let mut renderer = window.into_canvas().present_vsync().accelerated().build().unwrap();
    ...
    let video_reciever = rtp::RtpReciever::<[u8; VIDEO_WIDTH as usize]>::new(video_recieving_socket);
